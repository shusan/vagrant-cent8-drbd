...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    dnf install -y --enablerepo=elrepo kmod-drbd90 drbd90-utils

    # mysql
    dnf -y install https://repo.mysql.com/yum/mysql-5.7-community/el/7/x86_64/mysql-community-release-el7-7.noarch.rpm
    ...
    mysqladmin -p{Int_Passwd} password {MysqlRootPasswd}


    # dnf install -y --enablerepo=HighAvailability pacemaker corosync
  #   apt-get install -y apache2
  SHELL
end
